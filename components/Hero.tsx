...
export const Hero = () => {
  return (
    <section className='flex flex-col items-center justify-center text-center mt-16 md:mt-32 relative'>
      ...
      >
        Sebuah ruang kolaborasi tanpa sekat. Kami memadukan{' '}
        <span className='text-white font-medium'>seni</span>,{' '}
        <span className='text-white font-medium'>teknologi</span>, dan{' '}
        <span className='text-white font-medium'>cerita</span> dalam satu
        spektrum.
      </motion.p>
