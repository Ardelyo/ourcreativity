...
## OurCreativity Brand & Trademark Guidelines
...
This document outlines the trademark and brand usage policy for **OurCreativity**. While our source code is open source under the MIT License, our brand identity, trademarks, and visual assets are protected and subject to specific usage restrictions.

---

## 🏛️ Protected Trademarks

The following marks are trademarks of OurCreativity and are protected under applicable trademark laws:

### Primary Trademarks

1. **"OurCreativity"** (Wordmark)
   - All variations: OurCreativity, ourcreativity, OURCREATIVITY
   - In any language or translation

2. **OurCreativity Logo**
   - The official logo design and all variations
   - Logo symbols, icons, and graphical elements
   - Color schemes and visual identity

3. **"Luminous Design"** (Design Philosophy)
   - As applied to UI/UX design methodology
   - Associated design patterns and principles

4. **Taglines & Slogans**
   - "Merangkai Imajinasi, Menghidupkan Karya"
   - "Platform Komunitas Kreatif Generasi Berikutnya"
   - Any official taglines associated with OurCreativity

### Secondary Marks

- **"Revolution Edition"** (Version naming)
- **Bento Grid Navigation** (UI pattern branding)
- Official color palette (when used as brand identifier)
- Distinctive UI elements unique to OurCreativity
...
✓ "Compatible with OurCreativity API"
✓ "Inspired by OurCreativity design"
```
...
✗ "OurCreativity Plus"
✗ "MyApp powered by OurCreativity" (as product name)
```
...
✗ ourcreativity.net, .org, .io (or any TLD)
```
...
✗ Mobile apps named "OurCreativity [anything]"
```
...
If you receive permission to use OurCreativity trademarks, follow these guidelines:
...
- Trademark protection varies by jurisdiction
- This policy applies globally where OurCreativity trademarks are recognized
- Local laws may provide additional protections or restrictions
...
- [LICENSE](./LICENSE) - Software license (MIT)
- [NOTICE.md](./NOTICE.md) - Copyright and legal notices
