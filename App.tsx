...
const Story = React.lazy(() =>
  import('./pages/Story').then(module => ({ default: module.Story }))
);
const Announcement = React.lazy(() =>
  import('./pages/Announcement').then(module => ({
    default: module.Announcement,
  }))
);
const Graphics = React.lazy(() =>
  import('./pages/divisions/Graphics').then(module => ({
    default: module.Graphics,
  }))
);
const VideoPage = React.lazy(() =>
  import('./pages/divisions/Video').then(module => ({
    default: module.VideoPage,
  }))
);
const Writing = React.lazy(() =>
  import('./pages/divisions/Writing').then(module => ({
    default: module.Writing,
  }))
);
const Meme = React.lazy(() =>
  import('./pages/divisions/Meme').then(module => ({ default: module.Meme }))
);
const Coding = React.lazy(() =>
  import('./pages/divisions/Coding').then(module => ({
