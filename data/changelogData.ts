...
export const changelogData: ChangelogEntry[] = [
  {
    ...
    description:
      "Akhirnya rilis juga! Redesign total platform. Gila sih ini, bener-bener beda dari yang lama. Fokus ke estetika modern, interaksi yang 'mahal', dan experience yang premium abis.",
    type: 'major',
    icon: Sparkles,
    color: 'rose-500',
    changes: [
  ...
  },
  {
    ...
    title: 'Final Polish',
    description:
      'Beres-beres terakhir sebelum rilis gede. Ngerapihin yang kecil-kecil biar perfect.',
    type: 'patch',
    icon: CheckCircle,
    color: 'emerald-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Capek banget ngebenerin bug, tapi harus. Fokus total biar stabil pas dipake orang banyak.',
    type: 'patch',
    icon: Bug,
    color: 'blue-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Ngoprek config build biar performanya maksimal. Lumayan nambah speed.',
    type: 'minor',
    icon: Zap,
    color: 'yellow-500',
    changes: [
  ...
  },
  {
    ...
    description:
      'Nambahin satpam digital. Biar aman dan code-nya ga berantakan.',
    type: 'minor',
    icon: Lock,
    color: 'green-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Menu di HP jelek banget kemaren, jadi dibikin ulang biar enak dipencet.',
    type: 'minor',
    icon: Smartphone,
    color: 'purple-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Halaman depan dirombak total. Biar first impression-nya dapet.',
    type: 'minor',
    icon: Layout,
    color: 'orange-400',
    changes: [
  ...
  },
  {
    ...
    description:
      "Ini dia, bahasa desain kita sendiri: 'Glowar'. Gelap tapi bercahaya, dalem banget filosofinya.",
    type: 'major',
    icon: Palette,
    color: 'cyan-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Fokus benerin performa. Biar ga lemot pas dibuka di HP kentang.',
    type: 'patch',
    icon: Cpu,
    color: 'emerald-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Akhirnya fitur Karya nyambung sama backend. Udah bisa pamer beneran.',
    type: 'minor',
    icon: Image,
    color: 'pink-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Update visual dikit, biar lebih fresh. Konsepnya rasi bintang gitu.',
    type: 'minor',
    icon: Star,
    color: 'indigo-400',
    changes: [
  ...
  },
  {
    ...
    description:
      'Rilis panel admin. Akhirnya ga perlu ngoding buat update konten.',
    type: 'major',
    icon: Layout,
    color: 'slate-500',
    changes: [
  ...
  },
  {
    ...
    title: 'Halaman Karya',
    description:
      'Rilis fitur utama: Galeri Karya! Tempat pamer hasil kreativitas.',
    type: 'major',
    icon: Grid,
    color: 'red-500',
    changes: [
