    ...
    >
      ...
      >
        ...
        >
          ...
          <span className='text-[10px] font-bold tracking-[0.3em] uppercase text-emerald-200'>
            The Origins
          </span>
        </motion.div>
...
const PhilosophySection = () => {
  ...
  return (
    <section
      ref={ref}
      className='min-h-[150vh] relative py-32 flex flex-col items-center'
    >
        ...
        <div className='relative w-full aspect-video flex items-center justify-center'>
          ...
          >
            <div className='bg-black/80 backdrop-blur-md border border-rose-500/30 px-8 py-4 rounded-2xl'>
              ...
              <p className='text-rose-400 text-xs tracking-[0.5em] uppercase text-center mt-1'>
                Creativity
              </p>
            </div>
          </motion.div>
...
const LoopStep: React.FC<{
  ...
  progress: any;
  range: number[];
}> = ({ number, title, desc, progress, range }) => {
  ...
  const glow = useTransform(progress, range, [
    ...
    '0px 0px 40px rgba(16, 185, 129, 0.4)',
    '0px 0px 0px rgba(0,0,0,0)',
  ]);
  ...
  const steps = [
    {
      id: '01',
      title: 'Pemicu',
      desc: 'Konten inspiratif di Media Sosial menarik minat audiens untuk mencari tahu lebih lanjut.',
    },
    {
      id: '02',
      title: 'Bergabung',
      desc: 'Audiens merasa terpanggil dan bergabung ke dalam ekosistem OurCreativity.',
    },
    {
      id: '03',
      title: 'Aktivitas',
      desc: 'Anggota mulai berkarya, berdiskusi, dan berbagi ilmu dalam lingkungan yang suportif.',
    },
    {
      id: '04',
      title: 'Kolaborasi',
      desc: 'Publikasi karya di akun resmi untuk mendapatkan apresiasi, kritik membangun, dan branding.',
    },
    {
      id: '05',
      title: 'Regenerasi',
      desc: 'Member yang matang menjadi inspirasi baru, menutup siklus dengan menarik minat generasi berikutnya.',
    },
  ];

  return (
    <section
      className='bg-[#080808] relative py-32 overflow-hidden'
      ref={containerRef}
    >
      ...
      <div className='container mx-auto px-6 max-w-5xl relative'>
        ...
        >
          <span className='text-emerald-500 font-bold tracking-[0.3em] text-xs uppercase mb-4 block'>
            Ekosistem Kami
          </span>
          ...
          <p className='text-gray-500 mt-4'>
            Scroll ke bawah untuk melihat bagaimana siklus ini bekerja.
          </p>
        </motion.div>
      ...
      <div className='container mx-auto px-6 text-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {[
            ...
            {
              label: 'Waktu Terbentuk',
              val: '< 1 Thn',
              icon: Zap,
              color: 'text-yellow-400',
            },
            {
              label: 'Karya Terpublikasi',
              val: '500+',
              icon: Share2,
              color: 'text-rose-400',
            },
        ...
        <div className='mt-24 p-8 md:p-12 rounded-[3rem] bg-gradient-to-r from-gray-900 to-black border border-white/10 text-center max-w-4xl mx-auto'>
          <h3 className='text-2xl font-serif text-white mb-4'>
            Bergabunglah dengan Generasi Baru
          </h3>
          <p className='text-gray-400 mb-8 max-w-lg mx-auto'>
            Jadilah bagian dari siklus. Dari penikmat konten, menjadi pencipta
            konten.
          </p>
