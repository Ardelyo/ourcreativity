...
export const BentoGrid = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-12 gap-5 max-w-7xl mx-auto auto-rows-[minmax(180px,auto)] content-visibility-auto'>
      ...
      <Card
        className='md:col-span-8 md:row-span-2 bg-[#080808] text-white min-h-[450px] flex flex-col justify-between group border border-white/5 hover:border-white/10'
        delay={0.1}
      >
        ...
        <div className='relative z-10 flex justify-between items-start'>
          ...
          <Megaphone
            className='text-white/20 -rotate-12 group-hover:rotate-0 transition-transform duration-500'
            size={32}
          />
        </div>
          ...
          <div className='flex items-end justify-between gap-4'>
            <div className='space-y-4 max-w-md'>
              ...
              <p className='text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4'>
                Edisi terbaru telah hadir. Cek pembaruan visual dan fitur
                komunitas sekarang.
              </p>
            </div>
      ...
      <Card
        className='md:col-span-4 md:row-span-1 bg-black border border-white/5 hover:border-white/20 group cursor-pointer'
        delay={0.2}
      >
        <Link to='/karya' className='block h-full w-full'>
          ...
          <div className='absolute bottom-6 left-6 right-6 flex items-end justify-between z-10'>
            ...
            <ArrowUpRight
              size={18}
              className='text-white opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0'
            />
          </div>
        </Link>
      </Card>
      ...
      <Card
        className='md:col-span-4 md:row-span-1 bg-[#0a0a0a] border border-white/5 hover:border-white/20 group flex flex-col justify-center'
        delay={0.3}
      >
        <Link to='/tim' className='block w-full'>
          ...
          <div className='mt-4'>
            <div className='text-4xl font-sans font-bold text-white group-hover:text-rose-400 transition-colors'>
              3.2k+
            </div>
      ...
      <Card
        className='md:col-span-4 bg-[#0a0a0a] border border-white/5 hover:bg-[#0f0f0f] transition-colors flex flex-col justify-center'
        delay={0.4}
      >
        <Link to='/story' className='block h-full'>
          ...
          <p className='text-xs text-gray-400 leading-relaxed mb-4'>
            The Loop: Bagaimana kami membangun ekosistem kreatif yang
            berkelanjutan dari nol.
          </p>
      ...
      <Card
        className='md:col-span-4 bg-[#0a0a0a] border border-white/5 hover:bg-[#0f0f0f] flex flex-col justify-between'
        delay={0.5}
      >
      ...
      <Card
        className='md:col-span-4 bg-gradient-to-br from-[#111] to-[#050505] border border-white/5 hover:border-white/20 group relative'
        delay={0.6}
      >
        <Link
          to='/info'
