...
import {
    Rocket, Zap, Palette, Layout, Smartphone, Globe,
    Sparkles, ChevronDown, ChevronRight, Gauge,
    Database, Layers, ShieldCheck, Code2, Cpu, ArrowRight,
    MoveHorizontal, ExternalLink, Info
} from 'lucide-react';
import { Link } from 'react-router-dom';

// --- Komponen Latar Belakang: Luminous Fluid Enhanced ---
const FluidBackground = () => {
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 bg-[#020202]">
            {/* Orb 1: Rose Glow (Enhanced) */}
            <motion.div
                animate={{
                    x: [0, 100, -50, 0],
                    y: [0, -50, 100, 0],
                ...
                className="absolute -top-[20%] -left-[10%] w-[70vw] h-[70vw] bg-rose-600/30 blur-[150px] rounded-full mix-blend-screen"
            />
            {/* Orb 2: Purple Glow (Enhanced) */}
            <motion.div
                animate={{
                    x: [0, -80, 120, 0],
                    y: [0, 120, -60, 0],
                ...
                className="absolute -bottom-[20%] -right-[10%] w-[80vw] h-[80vw] bg-purple-600/20 blur-[180px] rounded-full mix-blend-screen"
            />
            {/* Orb 3: Cyan Accent (New) */}
            <motion.div
                animate={{
                    x: [0, 150, -100, 0],
                    y: [0, 100, 150, 0],
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] bg-blue-500/10 blur-[200px] rounded-full mix-blend-screen"
            />
            ...
            {/* Noise Texture */}
            <div className="absolute inset-0 opacity-[0.07] z-10 mix-blend-overlay pointer-events-none"
...
const CompareSlider = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="relative w-full aspect-video rounded-3xl overflow-hidden cursor-ew-resize select-none border border-white/10 shadow-2xl group"
        ...
        >
            ...
            >
                <img
                    ...
                    style={{ width: '100vw', maxWidth: 'unset' }} // Trick to keep aspect ratio
                // Note: In real implementation, we need to ensure both images align perfectly.
                // Assuming images are same aspect ratio.
                />
...
const MetricCard = ({ label, value, sub, delay }: { label: string, value: string, sub?: string, delay: number }) => (
    <motion.div
...
export const V5Launch = () => {
    ...
    return (
        <div ref={containerRef} className="relative bg-[#020202] text-white selection:bg-rose-500/30 font-sans overflow-x-hidden">
            <FluidBackground />
            ...
            {/* Navigasi Persisten */}
            <div className="fixed top-8 left-8 z-40 flex items-center gap-6 mix-blend-difference">
            ...
            {/* SLIDE 2: THE COMPARISON (INTERACTIVE) */}
            ...
            {/* SLIDE 3: LUMINOUS PHILOSOPHY (ZEN) */}
            <Slide>
