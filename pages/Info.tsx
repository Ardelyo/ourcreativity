...
const divisions = [
  ...
  },
  {
    ...
    link: '/division/coding',
  },
];

const faqs = [
  {
    q: 'Apakah komunitas ini gratis?',
    a: 'Ya, 100% gratis. Kami menyelenggarakan diskusi, event eksklusif, dan proyek kolaboratif tanpa biaya untuk pengembangan keterampilan anggota.',
  },
  {
    q: 'Bagaimana cara bergabung?',
    a: 'Cukup ikuti tautan di Linktree kami atau pantau Instagram @ourcreativity.ofc. Perekrutan biasanya diumumkan melalui konten media sosial.',
  },
  {
    q: 'Apakah pemula boleh ikut?',
    a: 'Sangat boleh. Komunitas ini dibentuk sebagai wadah belajar bagi mereka yang ingin mempelajari sesuatu namun tidak memiliki tempat bertanya.',
  },
  {
    q: "Apa itu sistem 'The Loop'?",
    a: 'Itu adalah ekosistem kami: Terpicu konten -> Bergabung -> Berkarya -> Kolaborasi -> Konsistensi -> Menjadi inspirasi baru (Regenerasi).',
  },
];
    ...
    <div className='pt-36 pb-20 px-4 max-w-6xl mx-auto min-h-screen'>
      ...
      >
        ...
        <p className='text-gray-400 max-w-2xl mx-auto text-lg'>
          Panduan lengkap, akses divisi, dan pertanyaan umum seputar ekosistem
          OurCreativity.
        </p>
      </motion.div>
              ...
              <Link to={div.link} key={i}>
                ...
                >
                  ...
                  <div className='flex items-start justify-between relative z-10'>
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${div.bg} ${div.color} mb-4`}
                    >
                      <div.icon size={24} />
                    </div>
                    <ChevronRight
                  ...
                  <h3 className='relative z-10 text-white font-bold text-lg mb-1'>
                    {div.name}
                  </h3>
            ...
            <div className='relative z-10 h-full flex flex-col'>
              <div className='mb-8'>
                ...
                <p className='text-sm text-gray-400'>
                  Punya tawaran kolaborasi atau pertanyaan mendesak?
                </p>
              </div>
              ...
              <div className='space-y-3 mt-auto'>
                <a
                  ...
                  className='flex items-center gap-3 text-sm text-white hover:text-rose-400 transition-colors p-3 bg-white/5 rounded-xl border border-white/5 hover:border-white/20'
                >
