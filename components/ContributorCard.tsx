...
export const ContributorCard: React.FC<ContributorProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className={`absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-2xl -z-10 ${isOwner
            ...
            <div className="relative bg-white/[0.03] backdrop-blur-sm border border-white/5 rounded-[2rem] p-6 transition-all duration-500 group-hover:bg-white/[0.06] group-hover:border-white/10 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    {/* Avatar Container */}
                    <div className={`relative w-20 h-20 mb-4 rounded-full p-1 transition-transform duration-500 group-hover:scale-105 ${isOwner ? 'bg-gradient-to-tr from-amber-500 to-rose-500' : 'bg-gradient-to-tr from-white/10 to-white/5'
                        }`}>
                        <img
                            src={avatar_url}
                            alt={login}
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-white/40 tracking-wide font-light">
                        <Sparkles size={10} className={isOwner ? "text-amber-400" : "text-purple-400"} />
