...
const writings = [
  {
    ...
    excerpt:
      'Dalam keheningan, kita menemukan kebisingan pikiran yang paling jujur. Sebuah kritik terhadap modernitas yang menolak jeda.',
    author: 'Sarah A.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Apakah intensi penulis masih relevan ketika teks telah dilepas ke publik? Membedah kembali teori Barthes di era media sosial.',
    author: 'Rian K.',
    image:
      'https://images.unsplash.com/photo-1476275466078-4007374efbbe?q=80&w=2629&auto=format&fit=crop',
  },
  {
    title: 'Kota Tanpa Jendela',
    category: 'Prosa',
    excerpt:
      'Mereka membangun dinding-dinding kaca, namun tak ada yang benar-benar melihat ke luar. Sebuah alegori tentang narsisme urban.',
    author: 'Dina M.',
    image:
      'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?q=80&w=2428&auto=format&fit=crop',
  },
];
    ...
    <SmoothScroll>
      <div className='min-h-screen bg-[#f4f1ea] text-[#1a1a1a] font-serif selection:bg-[#1a1a1a] selection:text-[#f4f1ea] overflow-x-hidden'>
        ...
        <nav className='fixed top-0 left-0 w-full z-40 px-6 py-6 flex justify-between items-center mix-blend-difference text-[#f4f1ea] pointer-events-none'>
          <Link
            to='/info'
            className='flex items-center gap-3 text-sm tracking-[0.2em] uppercase hover:opacity-70 transition-opacity pointer-events-auto font-sans font-medium'
          >
          ...
          <div className='max-w-[90vw]'>
            ...
            <h1 className='text-[12vw] leading-[0.85] font-medium tracking-tighter uppercase mb-12 mix-blend-multiply'>
              ...
              <RevealText
                text='Paling'
                delay={0.2}
                className='ml-[10vw] italic font-light'
              />
            ...
            <div className='flex flex-col md:flex-row justify-between items-end gap-12 border-t border-[#1a1a1a] pt-8'>
              <p className='max-w-md text-lg md:text-xl leading-relaxed font-sans text-[#1a1a1a]/80'>
                Di mana setiap kata ditimbang, setiap ide diuji, dan setiap
                tulisan adalah bentuk perlawanan terhadap kedangkalan.
              </p>
              <motion.div
                animate={{ y: [0, 10, 0] }}
        ...
        <section className='py-32 px-6 md:px-20 border-t border-[#1a1a1a]/10'>
          <div className='grid grid-cols-1 md:grid-cols-12 gap-12 items-start'>
            <div className='md:col-span-4 sticky top-32'>
              <span className='font-sans text-xs tracking-[0.2em] uppercase mb-6 block text-[#1a1a1a]/60'>
                Manifesto Kami
              </span>
              ...
              <p className='font-sans text-[#1a1a1a]/70 leading-relaxed mb-8'>
                Kami percaya bahwa tulisan bukan sekadar hiasan. Ia adalah
                senjata tajam yang membedah realitas. Di sini, kami tidak hanya
                belajar menulis indah, tapi belajar berpikir benar.
              </p>
            ...
            <div className='md:col-span-8 relative min-h-[100vh]'>
              ...
              <div className='relative z-10 bg-white p-8 shadow-xl max-w-md ml-auto transform rotate-2 mb-[-100px]'>
                ...
                <p className='text-2xl italic leading-tight mb-4'>
                  "Orang yang tidak bisa menulis, tidak bisa berpikir. Dan orang
                  yang tidak bisa berpikir, akan dikendalikan oleh orang lain."
                </p>
              ...
              <div className='absolute bottom-20 left-[-50px] bg-[#1a1a1a] text-[#f4f1ea] p-8 max-w-xs shadow-2xl transform -rotate-3 z-20 hidden md:block'>
                <span className='font-sans text-xs tracking-widest uppercase mb-2 block text-[#f4f1ea]/60'>
                  Aktivitas Rutin
                </span>
                <h3 className='text-2xl font-medium mb-4'>
                  Bedah Buku & Diskusi Filosofis
                </h3>
                <div className='h-[1px] w-full bg-[#f4f1ea]/20 mb-4'></div>
                <p className='font-sans text-sm text-[#f4f1ea]/80'>
                  Setiap Jumat malam. Membahas Camus, Nietzsche, hingga Sastra
                  Indonesia modern.
                </p>
              </div>
            </div>
        ...
        <section className='py-32 px-6 md:px-20 bg-[#1a1a1a] text-[#f4f1ea]'>
          <div className='flex flex-col md:flex-row justify-between items-end mb-20 border-b border-[#f4f1ea]/20 pb-8'>
            <div>
              <span className='font-sans text-xs tracking-[0.2em] uppercase mb-4 block text-[#f4f1ea]/60'>
                Arsip Karya
              </span>
              <h2 className='text-6xl md:text-8xl font-medium tracking-tight'>
                Antologi
              </h2>
            </div>
          ...
          <div className='space-y-32'>
            {writings.map((work, i) => (
              ...
              >
                <div
                  className={`w-full md:w-1/2 overflow-hidden ${i % 2 === 1 ? 'md:order-2' : ''}`}
                >
                ...
                <div
                  className={`w-full md:w-1/2 ${i % 2 === 1 ? 'md:text-right md:order-1' : ''}`}
                >
                  <span className='font-sans text-xs tracking-[0.2em] uppercase text-[#f4f1ea]/60 mb-4 block'>
                    {work.category}
                  </span>
                  <h3 className='text-5xl md:text-7xl mb-6 leading-[0.9] group-hover:italic transition-all duration-500'>
                    {work.title}
                  </h3>
                  <p
                    className={`font-sans text-[#f4f1ea]/70 text-lg leading-relaxed mb-8 max-w-md ${i % 2 === 1 ? 'ml-auto' : ''}`}
                  >
                    {work.excerpt}
                  </p>
                  <div
                    className={`flex items-center gap-4 ${i % 2 === 1 ? 'justify-end' : ''}`}
                  >
        ...
        <footer className='py-32 px-6 md:px-20 bg-[#f4f1ea] text-center'>
          <div className='max-w-3xl mx-auto'>
            <Feather
              size={64}
              className='mx-auto mb-12 text-[#1a1a1a]'
              strokeWidth={1}
            />
            ...
            <p className='font-sans text-lg text-[#1a1a1a]/70 mb-12 max-w-xl mx-auto'>
              Jangan biarkan idemu mati dalam diam. Mari berdialektika,
              mengkritik, dan menulis sejarah baru bersama kami.
            </p>
