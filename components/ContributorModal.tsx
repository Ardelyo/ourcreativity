      ...
      >
        ...
        >
          ...
          <div className='overflow-y-auto custom-scrollbar flex-1'>
            <div
              ref={modalRef}
              className='relative bg-[#030303] p-8 md:p-12 overflow-hidden min-h-[500px] flex flex-col items-center text-center'
            >
              {/* Abstract Background Art */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${getGradient(login)} blur-3xl opacity-50`}
              />
              ...
              <div className='relative z-10 w-full flex flex-col items-center'>
                ...
                <div className='relative mb-8 group'>
                  ...
                  <div
                    className={`w-32 h-32 rounded-full p-1 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 ${isOwner ? 'shadow-[0_0_40px_rgba(251,191,36,0.2)]' : ''}`}
                  >
                    <img
                      src={avatar_url}
                      alt={login}
                ...
                <div className='relative p-6 mb-8 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm max-w-sm'>
                  <Wand2
                    size={24}
                    className='absolute -top-3 -left-3 text-rose-400 rotate-12'
                  />
                  <p className='text-lg text-gray-300 font-serif italic leading-relaxed'>
                    "{persona.description}"
                  </p>
                  <div className='mt-4 flex justify-center gap-2'>
                    <span className='px-2 py-1 bg-white/5 rounded-md textxs text-gray-400 text-[10px] uppercase tracking-wider'>
                      {persona.element}
                    </span>
                    <span className='px-2 py-1 bg-white/5 rounded-md textxs text-gray-400 text-[10px] uppercase tracking-wider'>
                      {persona.adjective}
